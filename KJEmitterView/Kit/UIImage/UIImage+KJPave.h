...
/** 地板拼接效果 */
- (UIImage*)kj_imageFloorWithFloorJointType:(KJImageFloorJointType)type TargetImageSize:(KJImageSize)size FloorWidth:(CGFloat)floorWidth OpenAcross:(BOOL)openAcross OpenVertical:(BOOL)openVertical;
