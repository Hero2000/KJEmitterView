...
/** 地板拼接效果 */
- (UIImage*)kj_imageFloorWithFloorJointType:(KJImageFloorJointType)type TargetImageSize:(CGSize)size FloorWidth:(CGFloat)floorWidth OpenAcross:(BOOL)openAcross OpenVertical:(BOOL)openVertical;
